...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.22856256.svg)](https://doi.org/10.5281/zenodo.22856256)
...
The exact version 1.0.0 archive is available on Zenodo at
[doi:10.5281/zenodo.22856256](https://doi.org/10.5281/zenodo.22856256).
Please cite this version DOI when reproducing the manuscript figures.
Software citation metadata are in `CITATION.cff`.
